...
def greedy_closest_insertion(cities, initial = 0):
  pass

##### Inserção mais distance #####
def greedy_further_insertion(cities, initial = 0):
  pass

##### Inserção mais barata #####
def greedy_cheapest_insertion(cities, initial = 0):
  pass